...
class InvidiousApiClient
    implements Api<VideoList, CompleteVideo, VideoComments> {
  ...
  @override
  top() async =>
      _client.fetchJson("top").then((json) => VideoList.fromJson(json));
  ...
  @override
  video(String videoId) async => _client
      .fetchJson("videos/$videoId")
      .then((json) => CompleteVideo.fromJson(json));

  @override
  comments(String videoId) async => _client
      .fetchJson("comments/$videoId")
      .then((json) => VideoComments.fromJson(json));
